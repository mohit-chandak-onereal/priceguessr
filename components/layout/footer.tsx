...
export function Footer() {
  return (
    <footer className="border-t border-border-subtle bg-surface/50 backdrop-blur-md">
      <div className="container mx-auto px-4 py-8">
        <div className="grid grid-cols-1 md:grid-cols-4 gap-8">
          {/* Brand */}
          <div className="space-y-3">
            <h3 className="font-bold text-lg">PriceGuessr</h3>
            <p className="text-sm text-muted">
              Test your market knowledge and become a price guessing master!
            </p>
          </div>
          ...
          <div className="space-y-3">
            ...
            <ul className="space-y-2">
              <li>
                <Link href="/play" className="text-sm hover:text-primary transition-colors">
                  Quick Game
                </Link>
              </li>
              <li>
        ...
        <div className="mt-8 pt-8 border-t border-border-subtle">
          <div className="flex flex-col md:flex-row justify-between items-center space-y-4 md:space-y-0">
            <p className="text-sm text-muted">
              © 2024 PriceGuessr. All rights reserved.
            </p>
